    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.renameField.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                if (s.isNullOrEmpty()) {
                    binding.buttonCreatePlaylist.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.button_background_default))
                } else {
                    binding.buttonCreatePlaylist.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.cool_blue))
                }
            }
        })
