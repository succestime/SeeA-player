...
class TabAdapter(private val context: Context) : RecyclerView.Adapter<TabAdapter.MyHolder>() {

    class MyHolder(binding: TabLayoutBinding) : RecyclerView.ViewHolder(binding.root) {
